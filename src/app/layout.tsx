  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="mp-nutriactive";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="MP Nutriactive"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="mp-nutriactive"
